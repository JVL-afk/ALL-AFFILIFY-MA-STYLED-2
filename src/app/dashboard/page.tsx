    ...
    <div className="min-h-screen bg-orange-500">
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          <div className="bg-orange-500 bg-opacity-20 backdrop-blur-xl rounded-2xl p-6 border border-white border-opacity-30 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
          {/* Create Website */}
          <div className="bg-orange-500 bg-opacity-20 backdrop-blur-xl rounded-2xl p-8 border border-white border-opacity-30 text-center">
        ...
        {userInfo?.plan !== 'Basic' && (
          <div className="mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <Link href="/dashboard/advanced-analytics" className="bg-orange-500 bg-opacity-20 backdrop-blur-xl rounded-xl p-6 border border-white border-opacity-30 hover:bg-orange-500 bg-opacity-15 transition-all">
              ...
              <Link href="/dashboard/reviews" className="bg-orange-500 bg-opacity-20 backdrop-blur-xl rounded-xl p-6 border border-white border-opacity-30 hover:bg-orange-500 bg-opacity-15 transition-all">
              ...
              <Link href="/dashboard/ab-testing" className="bg-orange-500 bg-opacity-20 backdrop-blur-xl rounded-xl p-6 border border-white border-opacity-30 hover:bg-orange-500 bg-opacity-15 transition-all">
        ...
        {userInfo?.plan === 'Basic' && (
          <div className="text-center">
            <div className="bg-orange-500 bg-opacity-20 backdrop-blur-xl rounded-2xl p-8 border border-white border-opacity-30 max-w-2xl mx-auto">
